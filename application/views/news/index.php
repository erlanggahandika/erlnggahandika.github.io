...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="<?= base_url('news/index');?>">Appleria<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="<?= base_url('news/index');?>">News</a></li>
              <li><a href="<?= base_url('user/opss');?>">Sejarah</a></li>
              <li><a href="<?= base_url('user/opss');?>">Travel</a></li>
              <li><a href="<?= base_url('user/opss');?>">Business</a></li>
              <li><a href="<?= base_url('user/opss');?>">Health</a></li>
            </ul>
          </li>
      ...
      <a href="<?= base_url('display/log');?>" class="get-started-btn scrollto">Logout</a>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2>Pilih Catagory Artikel Anda</h2>
        </div>
      </div>
      ...
      <div class="col-xl-2 col-md-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" style="fill: rgb(255, 200, 50);transform: ;msFilter:;"><path d="M19.875 3H4.125C2.953 3 2 3.897 2 5v14c0 1.103.953 2 2.125 2h15.75C21.047 21 22 20.103 22 19V5c0-1.103-.953-2-2.125-2zm0 16H4.125c-.057 0-.096-.016-.113-.016-.007 0-.011.002-.012.008L3.988 5.046c.007-.01.052-.046.137-.046h15.75c.079.001.122.028.125.008l.012 13.946c-.007.01-.052.046-.137.046z"></path><path d="M6 7h6v6H6zm7 8H6v2h12v-2h-4zm1-4h4v2h-4zm0-4h4v2h-4z"></path></svg>
            <h3><a href="<?= base_url('news/index');?>">News</a></h3>
          </div>
        </div>
      <div class="col-xl-2 col-md-4">
          <div class="icon-box">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" style="fill: rgb(255, 200, 50);transform: ;msFilter:;"><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm7.931 9h-2.764a14.67 14.67 0 0 0-1.792-6.243A8.013 8.013 0 0 1 19.931 11zM12.53 4.027c1.035 1.364 2.427 3.78 2.627 6.973H9.03c.139-2.596.994-5.028 2.451-6.974.172-.01.344-.026.519-.026.179 0 .354.016.53.027zm-3.842.7C7.704 6.618 7.136 8.762 7.03 11H4.069a8.013 8.013 0 0 1 4.619-6.273zM4.069 13h2.974c.136 2.379.665 4.478 1.556 6.23A8.01 8.01 0 0 1 4.069 13zm7.381 6.973C10.049 18.275 9.222 15.896 9.041 13h6.113c-.208 2.773-1.117 5.196-2.603 6.972-.182.012-.364.028-.551.028-.186 0-.367-.016-.55-.027zm4.011-.772c.955-1.794 1.538-3.901 1.691-6.201h2.778a8.005 8.005 0 0 1-4.469 6.201z"></path></svg>
            <h3><a href="<?= base_url('user/opss');?>">Sejarah</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" style="fill: rgb(255, 200, 50);transform: ;msFilter:;"><path d="m2 9.76 9-2.45V10H7a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-4V6.76l9-2.45V2.24L2 7.69zM11 12v3H7v-3zm6 0v3h-4v-3z"></path></svg>
            <h3><a href="<?= base_url('user/opss');?>">Travel</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" style="fill: rgb(255, 200, 50);transform: ;msFilter:;"><path d="M20 7V5c0-1.103-.897-2-2-2H5C3.346 3 2 4.346 2 6v12c0 2.201 1.794 3 3 3h15c1.103 0 2-.897 2-2V9c0-1.103-.897-2-2-2zm-2 9h-2v-4h2v4zM5 7a1.001 1.001 0 0 1 0-2h13v2H5z"></path></svg>
            <h3><a href="<?= base_url('user/opss');?>">Business</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" style="fill: rgb(255, 200, 50);transform: ;msFilter:;"><path d="M19.649 5.286 14 8.548V2.025h-4v6.523L4.351 5.286l-2 3.465 5.648 3.261-5.648 3.261 2 3.465L10 15.477V22h4v-6.523l5.649 3.261 2-3.465-5.648-3.261 5.648-3.261z"></path></svg>
            <h3><a href="<?= base_url('user/opss');?>">Health</a></h3>
          </div>
        </div>
                ...
                <div class="masonry-blog clearfix">
                    <div class="left-side">
                        <div class="masonry-box post-media">
                             <img src="../assets/erlanggaa/upload/blog_masonry_01.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="blog-category-01.html" title="">News</a></span>
                                        <h4><a href="<?= base_url('template/index');?>" title="">The golden rules you need to know for a positive life</a></h4>
                                        <small><a href="<?= base_url('template/index');?>" title="">24 July, 2017</a></small>
                    ...
                    <div class="center-side">
                        <div class="masonry-box post-media">
                             <img src="../assets/erlanggaa/upload/blog_masonry_02.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-green"><a href="blog-category-01.html" title="">News</a></span>
                        ...
                        <div class="masonry-box small-box post-media">
                             <img src="../assets/erlanggaa/upload/blog_masonry_03.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-green"><a href="blog-category-01.html" title="">News</a></span>
                        ...
                        <div class="masonry-box small-box post-media">
                             <img src="../assets/erlanggaa/upload/blog_masonry_04.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-green"><a href="blog-category-01.html" title="">News</a></span>
                    ...
                    <div class="right-side hidden-md-down">
                        <div class="masonry-box post-media">
                             <img src="../assets/erlanggaa/upload/blog_masonry_05.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="blog-category-01.html" title="">News</a></span>
        ...
        <section class="section">
            <div class="container">
                <div class="row" data-aos="fade-up" data-aos-delay="150">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="section-title">
                            <h3 class="color-aqua"><a href="blog-category-01.html" title="">News</a></h3>
                        </div><!-- end title -->
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="blog-box" data-aos="fade-right" data-aos-delay="150">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_05.jpg" alt="" class="img-fluid">
                                ...
                                <div class="blog-box" data-aos="fade-up" data-aos-delay="150">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_06.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div><!-- end hover -->
                                        </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="section-title" data-aos="fade-left" data-aos-delay="100">
                            <h3 class="color-pink"><a href="blog-category-01.html" title="">News</a></h3>
                        </div><!-- end title -->
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_01.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div><!-- end hover -->
                                        </a>
                                ...
                                <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_02.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div><!-- end hover -->
                                        </a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_03.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div><!-- end hover -->
                                        </a>
                                    ...
                                    <div class="blog-meta">
                                        ...
                                        <small><a href="blog-category-01.html" title="">News</a>, <a href="blog-category-01.html" title=""></a></small>
                                ...
                                <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_04.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div><!-- end hover -->
                                        </a>
                ...
                <div class="row" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div class="blog-list clearfix">
                            ...
                            <div class="blog-box row" data-aos="fade-left" data-aos-delay="100">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_square_01.jpg" alt="" class="img-fluid">
                            ...
                            <div class="blog-box row" data-aos="fade-left" data-aos-delay="100">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_square_02.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect"></div>
                                        </a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                            ...
                            <div class="blog-box row" data-aos="fade-left" data-aos-delay="100">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html" title="">
                                            <img src="../assets/erlanggaa/upload/blog_square_03.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect"></div>
                                        </a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                    ...
                    <div class="col-lg-3">
                        <div class="section-title" data-aos="fade-left" data-aos-delay="100">
                            <h3 class="color-yellow"><a href="blog-category-01.html" title="">News</a></h3>
                        </div><!-- end title -->

                        <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                            <div class="post-media">
                                <a href="single.html" title="">
                                    <img src="../assets/erlanggaa/upload/blog_10.jpg" alt="" class="img-fluid">
                                    <div class="hovereffect">
                        ...
                        <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                            <div class="post-media">
                                <a href="single.html" title="">
                                    <img src="../assets/erlanggaa/upload/blog_11.jpg" alt="" class="img-fluid">
                                    <div class="hovereffect">
                                        <span class="videohover"></span>
                                    </div><!-- end hover -->
                                </a>
                        ...
                        <div class="blog-box" data-aos="zoom-in" data-aos-delay="250">
                            <div class="post-media">
                                <a href="single.html" title="">
                                    <img src="../assets/erlanggaa/upload/blog_12.jpg" alt="" class="img-fluid">
                                    <div class="hovereffect">
                                        <span class="videohover"></span>
                                    </div><!-- end hover -->
                                </a>
