...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Appleria | Oops wrong way!</title>
         ...
         <div class="row no-gutters height-self-center">
            <div class="col-sm-12 text-center align-self-center">
               <div class="iq-error position-relative">
                  ...
                  <a class="btn btn-primary btn-lg d-inline-flex align-items-center mt-3" href="<?= base_url('display/log');?>"><i class="ri-home-4-line"></i>Back to Home</a>
                  </div>
            </div>
         </div>
      </div>
