...
<link rel="apple-touch-icon" href="../assets/erlanggaa/images/apple-touch-icon.png">
  ...
  <!-- =======================================================
  * Template Name: Gp
  * Updated: Mar 10 2023 with Bootstrap v5.2.3Ss
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="<?= base_url('user/ubahpass');?>">Appleria<span>.</span></a></h1>
      ...
      <div class="form-prof">
                  <div class="template-prof" data-aos="fade-up" data-aos-delay="250">
                     ...
                     <?= form_open_multipart('user/ubahpass');?>
                        <!-- ini adalah funcction flashdata -->
                        <?= $this->session->flashdata('angga1'); ?>
                        <?= $this->session->flashdata('angga2'); ?>
                        <?= $this->session->flashdata('angga'); ?>
                        <!-- end flashdataa -->
                    ...
                    <div class="row-testt">
                       ...
                       <div class="top-input"  data-aos="fade-right" data-aos-delay="350">
                        ...
                        <div class="row-lgi">
                            ...
                            <div class="txt-input">
                            <input type="text" id="current_password"  name="current_password" value="">
                            </div>
                            <small class="nameform"><?= form_error('current_password'); ?></small>
                        </div>
                       </div>
                    ...
                    <div class="row-testting">
                       ...
                       <div class="top-input" data-aos="fade-right" data-aos-delay="400">
                        ...
                        <div class="row-lgi">
                            <div class="logo-atuh">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(5, 72, 255);transform: ;msFilter:;"><path d="M17 8V7c0-2.757-2.243-5-5-5S7 4.243 7 7v3H6c-1.103 0-2 .897-2 2v8c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2v-8c0-1.103-.897-2-2-2H9V7c0-1.654 1.346-3 3-3s3 1.346 3 3v1h2zm1 4 .002 8H6v-8h12z"></path></svg>
                            </div>
                            <div class="txt-input">
                            <input type="text" id="new_password1"  name="new_password1" value="">
                            </div>
                            <small class="nameform"><?= form_error('new_password1'); ?></small>
                        </div>
                       </div>
                    ...
                    <div class="row-testting">
                       ...
                       <div class="top-input" data-aos="fade-right" data-aos-delay="450">
                        ...
                        <div class="row-lgi">
                            ...
                            <div class="txt-input">
                            <input type="text" id="new_password2"  name="new_password2" value="">
                            </div>
                            <small class="nameform"><?= form_error('new_password2'); ?></small>
                        </div>
                       </div>
