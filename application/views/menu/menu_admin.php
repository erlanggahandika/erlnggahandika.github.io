...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="pt-3 pl-3">
                <a class="btn btn-primary mb-2" href="<?= base_url('menu/tambah'); ?>">Tambah Data</a>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableuser" data-aos="fade-right" data-aos-delay="600">
                            ...
                            <tbody>
                                <?php foreach ($data_admin as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('menu/edit/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
