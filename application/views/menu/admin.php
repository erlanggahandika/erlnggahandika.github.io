...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="pt-3 pl-3" data-aos="zoom-in" data-aos-delay="400">
                <a class="btn btn-primary mb-2" href="<?= base_url('#'); ?>">Tambah Data</a>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableuser" data-aos="fade-right" data-aos-delay="600">
                            ...
                            <tbody>
                                <?php foreach ($data_User as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('admin/editt/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
