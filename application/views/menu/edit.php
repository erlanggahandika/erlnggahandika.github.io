...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/edit1.css'); ?>">
                    ...
                    <div class="noted-bordering">
                        <div class="atur-border">
                            ...
                            <div class="text-infow" data-aos="fade-right" data-aos-delay="500">
                                <p>2. khusus untuk icon contohnya <\is class='bx bx-log-in\> diambil yang bagian " bx bx-log-in " lalu ditambah icon, jadi seperti ini "bx bx-log-in icon". icon didapat di boxicons</p>
                            </div>
                            <div class="text-infow" data-aos="fade-right" data-aos-delay="600">
                                <p>3. untuk link halaman admin. contoh admin/index</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-add">
                   ...
                   <form action="<?= base_url('menu/update');?>" method="post">
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="600">
                                ...
                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $data_admin->id; ?>">
                                   <input type="text" name="menu" value="<?= $data_admin->menu; ?>">
                               </div>
                            </div>
                            ...
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="700">
                                <p>Icon:</p>
                                <div class="bordernyae">
                                   <input type="text" name="icon" value="<?= $data_admin->icon; ?>">
                               </div>
                            </div>
                            ...
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="800">
                                <p>Link halaman:</p>
                                <div class="bordernyae">
                                   <input type="text" name="link" value="<?= $data_admin->link; ?>">
                               </div>
                            </div>
