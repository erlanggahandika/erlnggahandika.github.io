...
<head>
    ...
    <link rel="stylesheet" href="../assets/admin/css/tambah1.css">
                    ...
                    <div class="noted-bordering">
                        <div class="atur-border">
                            ...
                            <div class="text-infow" data-aos="fade-right" data-aos-delay="500">
                                <p>2. khusus untuk icon contohnya <\is class='bx bx-log-in\> diambil yang bagian " bx bx-log-in " lalu ditambah icon, jadi seperti ini "bx bx-log-in icon"</p>
                            </div>
                   ...
                   <form action="<?= base_url('menu/tambah');?>" method="post">
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="600">
                                ...
                                <div class="bordernyae">
                                   <input type="text" name="menu" placeholder="Masukan nama menu">
                               </div>
                            </div>
                            ...
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="700">
                                <p>Icon:</p>
                                <div class="bordernyae">
                                   <input type="text" name="icon" placeholder="Masukan Icon">
                               </div>
                            </div>
                            ...
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="800">
                                <p>Link halaman:</p>
                                <div class="bordernyae">
                                   <input type="text" name="link" placeholder="Masukan link halaman">
                               </div>
                            </div>
