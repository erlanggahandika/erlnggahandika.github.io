        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="form-add">
                   ...
                   <form action="<?= base_url('menu/updte');?>" method="post">
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="600">
                                <p>Nama menu:</p>
                                <div class="bordernyae">
                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $data_nav->id; ?>">
                                   <input type="text" name="menu" value="<?= $data_nav->menu; ?>">
                               </div>
                            </div>
                            ...
                            <div class="border-toper" data-aos="fade-right" data-aos-delay="800">
                                <p>Link halaman:</p>
                                <div class="bordernyae">
                                   <input type="text" name="link" value="<?= $data_nav->link; ?>">
                               </div>
                            </div>
