...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="pt-3 pl-3">
                <a class="btn btn-primary mb-2" href="<?= base_url('menu/add'); ?>">Tambah Data</a>
                </div>
            ...
            <div class="card" data-aos="fade-right" data-aos-delay="400">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="tableuser" data-aos="fade-right" data-aos-delay="600">
                            <thead>
                            ...
                            <tbody>
                                <?php foreach ($data_nav as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('menu/nav_edit/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
...
<script>
    ...
    $('#tableuser').on('click', '.item-delete', function() {
        ...
        //pada controller menu
        $('#btdelete').unbind().click(function() {
            $.ajax({
                type: 'ajax',
                method: 'get',
                async: false,
                url: '<?php echo base_url() ?>menu/deletee/',
                data: {
                    id: id
                },
                dataType: 'json',
