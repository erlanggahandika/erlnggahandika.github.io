...
-----------------------------------------------------------------------*/
    ...
    // Bar-chart
    if (jQuery("#apex-bar-contact").length) {
        options = {
            chart: {
                height: 530,
                type: "bar"
        ...
        (chart = new ApexCharts(document.querySelector("#apex-bar-contact"), options)).render()
        const body = document.querySelector('body')
        if (body.classList.contains('dark')) {
            apexChartUpdate(chart, {
                dark: true
    ...
    // chart-email-statistic
        var options = {
            series: [{
                    name: "Submitted",
                    data: [95, 92, 98, 94, 93, 96, 91, 90, 96, 98, 95, 90]
                },
                {
                    name: "Delivered",
                    data: [75, 71, 72, 72, 73, 78, 79, 77, 76, 71, 72, 75]
                },
                {
                    name: 'Opened',
                    data: [57, 57, 54, 59, 55, 58, 52, 57, 52, 56, 45, 47]
                },
                {
                    name: 'Clicked',
                    data: [25, 42, 28, 34, 43, 36, 31, 40, 16, 18, 35, 20]
                },
                {
                    name: 'Unsubscribed',
                    data: [17, 17, 14, 19, 15, 18, 12, 17, 12, 16, 15, 17]
                },
                {
                    name: 'Bounced',
                    data: [5, 1, 2, 2, 3, 8, 9, 7, 6, 1, 2, 5]
                },
            ],
            chart: {
                height: 450,
            ...
            colors: ["#FFEEA6", "#8E9EB1", "#323B50", "#FBB4FF", "#7678CC", "#FFC6B4"],
            dataLabels: {
                enabled: false
            },
            stroke: {
        ...
        var chart = new ApexCharts(document.querySelector("#chart-statistic"), options);
        chart.render();
